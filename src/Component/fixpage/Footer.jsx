...
const Footer = () => {
    return (
        <footer className="w-full bg-green-800 text-white py-12">
            <div className="max-w-[95%] mx-auto grid md:grid-cols-4 gap-8 px-6 md:px-0">
            ...
            <div className="mt-12 border-t border-green-700 pt-6 text-center text-gray-300 text-sm max-w-[95%] mx-auto">
